...
function _render(){ Module.renderImageFromMemory(); }



STATIC_BASE = GLOBAL_BASE;

STATICTOP = STATIC_BASE + 1925616;
...
var real__getMemoryOffset = asm["_getMemoryOffset"]; asm["_getMemoryOffset"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getMemoryOffset.apply(null, arguments);
};

var real__getScreenHeight = asm["_getScreenHeight"]; asm["_getScreenHeight"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getScreenHeight.apply(null, arguments);
};

var real__getScreenWidth = asm["_getScreenWidth"]; asm["_getScreenWidth"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__getScreenWidth.apply(null, arguments);
};
...
Module["asm"] = asm;
var ___em_js__render = Module["___em_js__render"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__render"].apply(null, arguments) };
...
var _getMemoryOffset = Module["_getMemoryOffset"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_getMemoryOffset"].apply(null, arguments) };
var _getScreenHeight = Module["_getScreenHeight"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_getScreenHeight"].apply(null, arguments) };
var _getScreenWidth = Module["_getScreenWidth"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_getScreenWidth"].apply(null, arguments) };
